...
<tr><td colspan="4"><textarea name="place_information" id="place_information" rows="10" cols="80" v>
${place.place_information }
            </textarea>
            <script>
